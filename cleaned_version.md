...
* Тут бы еще почитать про то, как принято в хемоинформатике сравнивать схожесть молекул - [Вот тут можно посмотреть](https://link.springer.com/article/10.1007/s12293-024-00414-6). Также там есть инфа о том как принято представлять молекулы.
